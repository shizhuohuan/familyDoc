        ...
        drawInfoWindow:function () {
            ...
            var html = '';
                html += '<div id="'+context.config.target+'" class="translucent-container">';
                    html += '<div class="translucent-title"><span>'+context.config.titleText+'</span><div class="translucent-control"><img id="translucent_small" title="最小化" src="../static/js/translucent/icon/small.png"/><img id="translucent_big" title="最大化" src="../static/js/translucent/icon/big.png"/><img id="translucent_close" title="关闭" src="../static/js/translucent/icon/close.png"/></div></div>';
        ...
        smallWindow:function () {
            ...
            $("#translucent_small").bind("click",function (e) {
                ...
                if(context.defaults._isScale){
                    ...
                    $(this).attr("title","还原");
                    $("#translucent_big").attr("src","../static/js/translucent/icon/big.png");
                    ...
                    $(this).attr("src","../static/js/translucent/icon/small.png");
                    $(this).attr("title","最小化");
                    context.defaults._isScale = true;
                }
                e.preventDefault();  //阻止默认事件
        ...
        maxWindow:function () {
            ...
            translucentBig.bind("click",function (e) {
                ...
                if(context.defaults._isMax){
                    ...
                    $(this).attr("src","../static/js/translucent/icon/huanyuan.png");
                    $(this).attr("title","还原");
                    ...
                    $(this).attr("src","../static/js/translucent/icon/big.png");
                    $(this).attr("title","最大化");
